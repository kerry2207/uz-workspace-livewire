...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'uz_workspace'),
    ...
    'redis' => [
        ...
        'options' => ['cluster' => env('REDIS_CLUSTER', 'redis'), 'prefix' => env('REDIS_PREFIX', Str::slug((string) env('APP_NAME', 'uz-workspace')).'-database-')],
