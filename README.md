...
Повний знімок вихідного коду також доданий у корінь репозиторію як `uz-workspace-livewire-source.zip`. Це резервний спосіб передачі: архів можна завантажити й розпакувати, якщо GitHub ще обробляє окремі вкладені файли.
